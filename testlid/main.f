...
*>I THINK THERE IS NO NEED TO DISTINGUISH POINT TYPES(INTERIOR OR BOUNDARY POINT)
     ...
     1       (U(I,J)+U(I-1,J))/2/RAD*MODEKSI 
      ...
      V(I,J-1)=V(I,J-1)-2.0*DT*DP/DY
      ENDIF
      WRITE(10,'(7ES15.5)')DIV,DP,P(I,J),U(I,J),U(I-1,J),
     1                     V(I,J),V(I,J-1)
      ENDDO
      ENDDO
      CLOSE(10)
...
*>VELOCITY
      ...
      OPEN(10,FILE=FILE1)
      WRITE(10,'(A)')'VARIABLES="X","Y","STRL","U","V","P"'
      WRITE(10,100)M+1,N+1
      DO J=1,N+1
      DO I=1,M+1
      WRITE(10,101)XC(I,J),YC(I,J),QST(I,J),UT(I,J),VT(I,J),
     1             PT(I,J)
      ENDDO
      ENDDO
      CLOSE(10)
100   FORMAT(1X,'ZONE T="FLOW",I=',I4,' , J=',I4,' , F=POINT')
101   FORMAT(1X,2F10.5,4ES20.5)
      RETURN
