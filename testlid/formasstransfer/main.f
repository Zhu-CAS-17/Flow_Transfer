...
200   FORMAT(1X,'DT=',F8.4,1X,'ALPHA=',F8.4,1X)
      ...
      REAL(KIND=8)::YINMAX,TINMAX
      OPEN(10,FILE='chamber.dat')
      READ(10,*)
      READ(10,*)
      READ(10,30)NUMX,NUMY
      NUMXY=NUMX*NUMY
30    FORMAT(1x,'zone t= "chamber",i=',I3,' , j=',I3,' , f= point') 
      ALLOCATE(XIN(NUMXY),YIN(NUMXY),TIN(NUMXY))
      DO I=1,NUMXY
      READ(10,'(3F10.4)')XIN(I),YIN(I),TIN(I)
      ENDDO
      CLOSE(10)
      YINMAX=MAXVAL(YIN,1,I,1,1);TINMAX=MAXVAL(TIN,1,I,1,1)
      XIN=XIN/0.0254;YIN=(YIN-YINMAX)/0.0254+1
      CALL MATRIXTOMATRIX(TIN,XIN,YIN,NUMX,NUMY,
     1            TEM,XC(1:M+1,1),YC(1,1:N+1),M+1,N+1) 
      RETURN
      ...
      ALLOCATE(COND(M+1,N+1),TEM(M+1,N+1))
*>PROJSOLA CONTROL PARAMETERS****************************************
